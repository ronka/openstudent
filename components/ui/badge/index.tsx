...
// Upstream `styled()` types don't infer this config shape correctly (gluestack-ui
// CLI generated code) - cast to `any` to unblock typechecking without corrupting
// the props type used by the JSX usages below.
const StyledUIIcon: any = styled(UIIcon, {
  className: {
    target: 'style',
    nativeStyleToProp: {
      height: true,
